...
from token_transform import build_codebook
...
def get_args_parser():
    ...
    parser.add_argument('--warmup-epochs', type=int, default=30, metavar='N',
    ...
    parser.add_argument('--tokenadapt-path', default=None, type=str, metavar='MODEL',
...
def main(args):
    ...
    codebook_modules, num_tokens = build_codebook(args)
    codebook_modules.to(device)
    ...
    if mixup_active:
        mixup_fn = Mixup(
            mixup_alpha=0.0, cutmix_alpha=args.cutmix, cutmix_minmax=args.cutmix_minmax,
    ...
    if args.eval:
        test_stats = evaluate(data_loader_val, model, codebook_modules[0], device)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            model, codebook_modules, criterion, data_loader_train,
            optimizer, device, epoch, loss_scaler,
            args.clip_grad, model_ema, mixup_fn, mixup_ta_fn,
